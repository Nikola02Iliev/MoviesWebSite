...
namespace MoviesWebSite.Areas.Identity.Pages.Account.Manage
{
    public class DeletePersonalDataModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var userMovies = await _context.Movies.Where(m => m.UserId == userId).ToListAsync();
            ...
            _context.Movies.RemoveRange(userMovies);
